...
public final class Messages {
    ...
    public static final String INPUT_CLOSED = "Ввод закрыт. Работа приложения завершена.";
    ...
    public static final String STARTUP_MIGRATION_FAILED = "Не удалось выполнить миграции базы данных.";

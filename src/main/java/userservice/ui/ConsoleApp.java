...
public final class ConsoleApp {
     ...
     */
    public ConsoleApp() {
        this(new UserServiceImpl(), new ConsolePrinter());
    }

    /**
     * Создаёт консольное приложение с переданными зависимостями.
     *
        ...
        try (InputReader inputReader = new InputReader()) {
            ...
            while (running) {
                try {
                    ...
                    LOGGER.error("Непредвиденная ошибка во время обработки команды", e);
    ...
    private void createUser(InputReader inputReader) {
        String name = inputReader.readName("Введите имя: ");
    ...
    private void updateUser(InputReader inputReader) {
        ...
        String name = inputReader.readName("Введите новое имя: ");

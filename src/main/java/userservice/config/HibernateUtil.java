...
/**
 * Служебный класс для создания {@link SessionFactory}
 * и безопасного выполнения операций Hibernate.
 */
public final class HibernateUtil {
    ...
    private static SessionFactory buildSessionFactory() {
        try {
            ...
            LOGGER.error("Не удалось инициализировать Hibernate SessionFactory", e);
            throw new ApplicationStartupException(Messages.STARTUP_HIBERNATE_FAILED, e);
        }
    }
